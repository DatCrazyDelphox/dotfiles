...
alias krita='KRITA_NO_STYLE_OVERRIDE=1 krita'
alias set-proton='export STEAM_COMPAT_DATA_PATH=$HOME/Games/proton'
alias run-proton='/home/datcr/.steam/steam/compatibilitytools.d/Proton-5.9-GE-5-ST/proton run'
alias weather="curl 'wttr.in/ferraz_de_vasconcelos?lang=pt-br'"
...
export PATH=$PATH:/home/datcr/.local/bin
export WINEARCH=win64
source /usr/share/doc/pkgfile/command-not-found.zsh
export KEYMAP=us-acentos
...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(vi_mode status command_execution_time ram public_ip)
...
#. "/home/datcr/.acme.sh/acme.sh.env"
